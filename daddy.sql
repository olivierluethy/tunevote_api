...
CREATE TABLE `voting_rounds` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `phase` enum('suggesting','voting','closed') NOT NULL DEFAULT 'suggesting',
...
--
-- Dumping data for table `voting_rounds`
--
...
--
ALTER TABLE `youtube_video_cache`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34509;
